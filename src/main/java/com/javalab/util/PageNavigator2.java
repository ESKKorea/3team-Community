   ...
   public String getPageNavigator2(int totalCount, int listCount, int pagePerBlock,
      ...
      if(totalCount > 0) {   //총 레코드 수가 하나라도 있어야 페이징
         ...
         if(pageNum > 1){   // 쿼리스트링에서 & = &amp; 
            sb.append("<a href=\"").append("galleryList?pageNum=1");
            sb.append("\" title=\"<<\"><<</a>&nbsp;");
         }
         //
         if (isPrev) {   
            int goPrevPage = startPage - pagePerBlock;         
            sb.append("&nbsp;&nbsp;<a href=\"").append("galleryList?pageNum="+goPrevPage+"");
            sb.append("\" title=\"<\"><</a>");
         } else {
         ...
         for (int i = startPage; i <= endPage; i++) {
            if (i == pageNum) {
               ...
               sb.append("<a href=\"").append("galleryList?pageNum="+i);
         ...
         if (isNext) {
            ...
            sb.append("<a href=\"").append("galleryList?pageNum="+goNextPage);
            sb.append("\" title=\">\">></a>");
         } else {
            
         }
         if(totalNumOfPage > pageNum){
            sb.append("&nbsp;&nbsp;<a href=\"").append("galleryList?pageNum="+totalNumOfPage);
            sb.append("\" title=\">>\">>></a>");
         }
      }
