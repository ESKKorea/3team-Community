        ...
        <div class="nav_but">
			...
			<c:choose>
				<c:when test="${not empty sessionScope.member}">
					<a href="<c:url value='/boardList' />"><span class="label">자유게시판</span></a>
					<a href="<c:url value='/galleryList' />"><span class="label">갤러리</span></a>
					<a href="<c:url value='/petList' />"><span class="label">분양
							게시판</span></a>
				</c:when>
				<c:otherwise>
					<a href="<c:url value='/login' />"><span class="label">자유게시판</span></a>
					<a href="<c:url value='/login' />"><span class="label">갤러리</span></a>
					<a href="<c:url value='/login' />"><span class="label">분양
							게시판</span></a>
				</c:otherwise>
			</c:choose>
			...
			<c:choose>
				<c:when test="${empty sessionScope.member}">
					<a href="<c:url value='/login'/>"><span class="label">로그인</span></a>
					<a href="<c:url value='/member'/>"><span class="label">회원가입</span></a>
				</c:when>
				<c:otherwise>
					<p>
						<strong>${sessionScope.member.name}</strong>님 환영합니다!
					</p>
					<a href="<c:url value='/logoutServlet'/>"><span class="label">로그아웃<i
